        ...
        <div class="w-full h-full flex relative py-3 px-3">
            ...
            <div class="w-2/4 h-full bg-white rounded">
                ...
                <form action="{{ route('login') }}" method="POST" class="w-full h-full py-3 px-5">
                    @csrf
                    <p class="font-bold py-3">login</p>

                    <span class="py-3">email</span>
                    ...
                    <button class="w-full py-3 px-5 bg-black text-white rounded my-3" type="submit">masuk</button>
                </form>
            </div>
        </div>
    </div>
