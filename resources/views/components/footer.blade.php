<footer class="min-w-full py-3 px-5 bg-white shadow">
    <div class="flex justify-between items-center">
        <div class="w-96">
            <p class="text-2xl font-bold">eLearning</p>
        ...
        <ul>
            <p class="font-bold capitalize">kategori populer</p>
        ...
        <ul>
            <p class="font-bold capitalize">acara terbaru</p>
        ...
        <ul>
            <p class="font-bold capitalize">sumber belajar</p>
